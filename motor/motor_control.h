...
#define LEFT_MOTOR_IN1 PCA_CHANNEL_2
#define LEFT_MOTOR_IN2 PCA_CHANNEL_1
#define RIGHT_MOTOR_PWM PCA_CHANNEL_5
#define RIGHT_MOTOR_IN1 PCA_CHANNEL_3
#define RIGHT_MOTOR_IN2 PCA_CHANNEL_4
